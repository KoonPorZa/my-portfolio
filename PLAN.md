...
| Layer       | Choice                                  | เหตุผล |
|-------------|-----------------------------------------|--------|
| Framework   | **Next.js 15** (App Router, TypeScript) | SEO, deploy ง่าย, ต่อ domain ง่าย |
...
| Deploy      | **Cloudflare Workers**                  | edge-native, Workers Builds, ต่อ custom domain |
...
- [ ] **P5 — Deploy**
  - push → Cloudflare Workers → ต่อ `koonporza.com` (ดู `DEPLOY.md`)
