...
export const stops: Stop[] = [
  ...
  },
  {
    ...
    role: "มื้อกลางวัน 30 นาที",
    note: "ถึงช่วงบ่าย ใช้เป็นมื้อกลางวันก่อนช่วงชุมพร เติมน้ำมันและยืดตัวก่อนขี่ยาว",
    tags: ["Day run", "Lunch"],
  },
  {
    legKm: 118.9,
  ...
  },
  {
    ...
    note: "ปั๊ม 24 ชม. ก่อนถึงโรงแรม เติมน้ำมันและเช็กความพร้อมก่อนพักค้างคืน",
    tags: ["24/7", "Decision"],
  },
  {
    legKm: 139.4,
