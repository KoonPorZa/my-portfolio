...
// Vendored from reactbits.dev (LogoLoop, TS+Tailwind). rAF-driven seamless
// marquee with ResizeObserver-based copy counting, edge fade, pause/scale on
// hover, and prefers-reduced-motion support.
